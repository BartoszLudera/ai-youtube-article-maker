...
SECRET_KEY = 'django-insecure-0vgcj-w!3ep(%z$4rywn@(@lre6rrmt*yeh9nd6iwa2%uv76tb'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'blog',  # Replace 'your_database_name' with the name of your PostgreSQL database
        ...
        'HOST': 'localhost',           # Replace 'localhost' with your PostgreSQL host, if needed
